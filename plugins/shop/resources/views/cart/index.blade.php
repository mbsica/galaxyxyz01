...
@section('content')
    ...
    <div class="container pl-0 pr-0">
        <div class="h3 deco-h"><span> <span class="text-red">{{ trans('shop::messages.cart.title') }}</span></span></div>
    </div>
    <div class="container shop-card">
        @if(! $cart->isEmpty())
            ...
            <div class="row">
                <div class="col-md-8">
                    <h5 style="color: #c51b1b;">{{ trans('shop::messages.cart.coupons') }}</h5>
                ...
                <div class="col-md-4">
                    <h5 style="color: #c51b1b;">{{ trans('shop::messages.cart.add-coupon') }}</h5>
                    ...
                    <form action="{{ route('shop.cart.coupons.add') }}" method="POST" class="form-inline mb-3">
                        ...
                        <button type="submit" class="btn btn-info">{{ trans('messages.actions.add') }}</button>
                    </form>
                </div>
            </div>
            ...
            <div class="row">
                ...
                <div class="col-md-6 text-right">
                    ...
                    @else
                        <a href="{{ route('shop.payments.payment') }}" class="btn btn-success">
