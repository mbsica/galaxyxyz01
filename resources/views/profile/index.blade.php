    ...
    <div class="container pl-0 pr-0">
        <div class="card mb-4 shadow-sm">
            <div class="card-header">
                <div class="h4 deco-h pr-0"><span>{{ trans('messages.profile.title') }}</span></div>
            </div>
            <div class="card-body">
                <div class="row">
        ...
        @if(! oauth_login())
            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="card shadow-sm mb-4">
                        <div class="card-header pr-0">
                            <div class="h5 deco-h-2 pr-0"><span>{{ trans('messages.profile.change-password') }}</span></div>
                        </div>
                        <div class="card-body">
                ...
                <div class="col-md-6">
                    <div class="card shadow-sm mb-4">
                        <div class="card-header pr-0">
                            <div class="h5 deco-h-2 pr-0"><span>{{ trans('messages.profile.change-email') }}</span></div>
                        </div>
                        <div class="card-body">
                ...
                @if(setting('user_money_transfer'))
                    <div class="col-md-6">
                        <div class="card shadow-sm mb-4">
                            <div class="card-header pr-0">
                                <div class="h5 deco-h-2 pr-0"><span>{{ trans('messages.profile.money-transfer.title') }}</span></div>
                            </div>
                            <div class="card-body">
